...
// Note the following:
// • In the static method named Marry, the Person objects are passed as parameters
// named p1 and p2 to the instance method Marry.
// • In the instance method named Marry, the spouse is set to the partner passed as a
// parameter, and the married Boolean is set to true.