using Packt.Shared;
using Env = System.Environment; // Renaming a type with a using alias
...
// You could also use the relational pattern in combination with the property pattern to avoid the nested
...
// jeff.FirstName = "Geoff";  // Gives error it is immutable
